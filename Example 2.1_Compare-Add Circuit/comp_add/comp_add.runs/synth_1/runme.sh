...
HD_PWD='E:/Documents/FPGA/Example 2.1_Compare-Add Circuit/comp_add/comp_add.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comp_add.tcl
