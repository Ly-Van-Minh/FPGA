...
HD_PWD='E:/Documents/FPGA/Example 2.1_Compare-Add Circuit/comp_add/comp_add.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_add.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comp_add.tcl -notrace
